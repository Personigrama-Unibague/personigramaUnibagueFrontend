...
export const getPeopleDistinct = async (unity) => {
  try {
    const response = await axios.get(
      `${API_URL}/api/v1/personal/getPersonasDistinct/${unity}`
    );
...
export const getEmployeeByUnity = async (unity) => {
  try {
    const response = await axios.get(
      `${API_URL}/api/v1/personal/findPersonalByUnidad/${unity}`
    );
...
export const findPersonById = async (id) => {
  try {
    const response = await axios.get(
      `${API_URL}/api/v1/personal/findPersonaById/${id}`
    );
    return response.data;
  } catch (error) {
    console.error(error);
...
export const deletePersonById = async (id, unity) => {
  try {
    await axios.get(
      `${API_URL}/api/v1/personal/deletePersonaById/${id}/${unity}`
    );
  } catch (error) {
    console.error(error);
  }
...
export const updateIdJerarByCedulaUnd = async (id, cedula, unity) => {
  try {
    await axios.get(
      `${API_URL}/api/v1/personal/updateIdJerarByCedulaUnd/${id}/${cedula}/${unity}`
    );
  } catch (error) {
    console.error(error);
  }
...
export const updateIdJerarDefault = async (cedula, unity) => {
  try {
    await axios.get(
      `${API_URL}/api/v1/personal/updateIdJerarByCedulaUnd/${cedula}/${unity}`
    );
  } catch (error) {
    console.error(error);
  }
...
export const updateIdJerarDefaultALlSection = async (id_jerar, unity) => {
  try {
    await axios.get(
      `${API_URL}/api/v1/personal/updateIdJerarDefaultAllSection/${id_jerar}/${unity}`
    );
  } catch (error) {
    console.error(error);
  }
